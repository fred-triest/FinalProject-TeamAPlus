...
public class ConfigureASystem {
    ...
    public static AirportEcoSystem configure() {
        ...
        UserAccount sysAdminUA = system.getUserAccountDirectory().createUserAccount("sysadmin", "sysAdmin1&", sysAdminEmployee, new SystemAdminRole());
        ...
        UserAccount jalAdminUA = japanAirlines.getUserAccountDirectory().createUserAccount("jaladmin", "jalAdmin1&", jalAdminEmployee, new EnterpriseAdminRole(japanAirlines));
        ...
        UserAccount nypaAdminUA = newYorkPortAuthority.getUserAccountDirectory().createUserAccount("nypaadmin", "nypaAdmin1&", nypaAdminEmployee, new EnterpriseAdminRole(newYorkPortAuthority));
        ...
        UserAccount groundAdminUA = groundMasterServices.getUserAccountDirectory().createUserAccount("groundadmin", "groundAdmin1&", groundAdminEmployee,new EnterpriseAdminRole(groundMasterServices));
        ...
        UserAccount flightSchedulerUA = flightOps.getUserAccountDirectory().createUserAccount("flightScheduler", "flightScheduler1&", flightSchedulerEmployee, new FlightSchedulerRole(flightOps));
        ...
        UserAccount operationsManagerUA = flightOps.getUserAccountDirectory().createUserAccount("operationsManager", "operationsManager1&", operationsManagerEmployee, new OperationsManagerRole(flightOps));
        ...
        UserAccount passengerAgentUA = passengerServices.getUserAccountDirectory().createUserAccount("passengerAgent", "passengerAgent1&", passengerAgentEmployee, new PassengerServicesAgentRole(passengerServices));
        ...
        UserAccount gateCoordinatorUA = gateTerminal.getUserAccountDirectory().createUserAccount("gateCoordinator", "gateCoordinator1&", gateCoordinatorEmployee, new GateCoordinatorRole(gateTerminal));
        ...
        UserAccount safetyInspectorUA = safetyBureau.getUserAccountDirectory().createUserAccount("safetyInspector", "safetyInspector1&", safetyInspectorEmployee, new SafetyInspectorRole(safetyBureau));
        ...
        UserAccount complianceOfficerUA = safetyBureau.getUserAccountDirectory().createUserAccount("complianceOfficer", "complianceOfficer1&", complianceOfficerEmployee, new ComplianceOfficerRole(safetyBureau));
        ...
        UserAccount rampSupervisorUA = rampRefueling.getUserAccountDirectory().createUserAccount("rampSupervisor", "rampSupervisor1&", rampSupervisorEmployee, new RampSupervisorRole(rampRefueling));
        ...
        UserAccount baggageHandlerUA = baggageServices.getUserAccountDirectory().createUserAccount("baggageHandler", "baggageHandler1&", baggageHandlerEmployee, new BaggageHandlerRole(baggageServices));
